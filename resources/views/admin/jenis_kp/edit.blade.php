...
@section('title') Edit Jenis Kenaikan @endsection
            ...
            <div class="card">
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="font-size-16 mb-1">Edit Jenis Kenaikan</h5>
                ...
                <div id="addproduct-productinfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                        <form action="{{ route('admin.jenis_kp.update', $jenis_kenaikan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label class="form-label" for="jenis_kenaikan">Jenis Kenaikan</label>
                                <input id="jenis_kenaikan" value="{{ old('jenis_kenaikan', $jenis_kenaikan->jenis_kenaikan) }}" name="jenis_kenaikan" placeholder="Masukan Jenis Kenaikan Pangkat"
